...
var resizePizzas = function(size) {
 ...
 function changePizzaSizes(size) {
    ...
    // The was created to prevent the brower from overrendering and repainting
    for (var d = 0; d < pizzaContainerLength; d++) {
     randomPizzaContainer[d].style.width = newwidth[d];
    }
  }
